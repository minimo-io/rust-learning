...
fn main() {
    ...
    // there are those iterators that consume the iterator (those that call next() method of the Iterator trait).
    // Eg. the sum() method.
    ...
    // and there are ITERATOR ADAPTERS that produce iterators
